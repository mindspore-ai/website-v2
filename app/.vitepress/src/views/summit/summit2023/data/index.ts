...
export default {
  ...
  detail: [
    '为加快构建人工智能开源生态建设，发展AI根技术，树立国产AI框架可用好用的信心，昇思MindSpore 开源社区拟于6月16日在上海举办人工智能框架生态峰会2023。大会围绕“新方向、新版本、新应用、新模式”主题展开，并将汇聚国内外AI领域领军学者、开源社区领袖、商业精英以及技术大咖等各方，共同分享AI技术发展趋势与产业机遇。',
  ],
  statistics: [
